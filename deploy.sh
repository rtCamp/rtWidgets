...
# main config
export PLUGINSLUG="rtwidgets"  #must match with wordpress.org plugin slug
export MAINFILE="rtwidgets-main.php" # this should be the name of your main php file in the wordpress plugin
